...
\begin{enumerate}
   ...
   \item \begin{minted}{Java}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.5, bb= 0 0 240 514]{media/3.2.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.5, bb= 0 0 407 351]{media/3.3.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.5, bb= 0 0 418 330]{media/3.4.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5, bb=0 0 197 325]{media/3.5.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.5, bb = 0 0 288 108]{media/3.6.eps}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale = 0.5, bb = 0 0 222 178]{media/3.7.eps}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[scale=0.5, bb=0 0 275 198]{media/3.8.eps}
